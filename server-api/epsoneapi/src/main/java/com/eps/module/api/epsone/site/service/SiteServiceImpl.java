...
public class SiteServiceImpl extends BaseBulkUploadService<SiteBulkUploadDto, Site> implements SiteService {
    ...
    public Function<Site, SiteBulkUploadDto> getEntityToDtoMapper() {
        return entity -> SiteBulkUploadDto.builder()
                ...
                .channelManagerContact(entity.getChannelManagerContact() != null ? entity.getChannelManagerContact().getContactNumber() : null)
                .regionalManagerContact(entity.getRegionalManagerContact() != null ? entity.getRegionalManagerContact().getContactNumber() : null)
                .stateHeadContact(entity.getStateHeadContact() != null ? entity.getStateHeadContact().getContactNumber() : null)
                .bankPersonContact(entity.getBankPersonContact() != null ? entity.getBankPersonContact().getContactNumber() : null)
                .masterFranchiseeContact(entity.getMasterFranchiseeContact() != null ? entity.getMasterFranchiseeContact().getContactNumber() : null)
