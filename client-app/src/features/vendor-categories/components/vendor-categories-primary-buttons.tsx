import { Plus, Download, Upload, Loader2, FileUp, ChevronDown, FileSpreadsheet } from 'lucide-react';
...
export function VendorCategoriesPrimaryButtons() {
  const { setSelectedVendorCategory, setIsDrawerOpen, openBulkUploadDialog } = useVendorCategories();
  ...
  const handleDownloadTemplate = async () => {
    ...
    try {
      await downloadFile(
        '/api/vendor-categories/bulk/export-template',
        'VendorCategory_Upload_Template.xlsx'
      );
