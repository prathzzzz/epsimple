...
export function ActivitiesListPrimaryButtons() {
  ...
  return (
    <div className="flex items-center gap-2">
      <PermissionGuard anyPermissions={["ACTIVITY_LIST:BULK_UPLOAD", "ACTIVITY_LIST:EXPORT"]}>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64">
            <PermissionGuard permission="ACTIVITY_LIST:BULK_UPLOAD">
            ...
            <PermissionGuard permission="ACTIVITY_LIST:EXPORT">
              <DropdownMenuSeparator />
      ...
      <PermissionGuard permission="ACTIVITY_LIST:CREATE">
