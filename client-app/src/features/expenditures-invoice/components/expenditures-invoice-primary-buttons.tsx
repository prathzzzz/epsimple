...
export function ExpendituresInvoicePrimaryButtons() {
  ...
  return (
    <div className="flex items-center gap-2">
      <PermissionGuard anyPermissions={["EXPENDITURE_INVOICE:BULK_UPLOAD", "EXPENDITURE_INVOICE:EXPORT"]}>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64">
            <PermissionGuard permission="EXPENDITURE_INVOICE:BULK_UPLOAD">
              <DropdownMenuItem
            ...
            <PermissionGuard permission="EXPENDITURE_INVOICE:EXPORT">
              <DropdownMenuSeparator />
      ...
      <PermissionGuard permission="EXPENDITURE_INVOICE:CREATE">
