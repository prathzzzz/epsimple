...
export function ManagedProjectPrimaryButtons() {
  ...
  return (
    <div className='flex items-center gap-2'>
      <PermissionGuard anyPermissions={['MANAGED_PROJECT:BULK_UPLOAD', 'MANAGED_PROJECT:EXPORT']}>
        <DropdownMenu>
          ...
          <DropdownMenuContent align='start' className='w-64'>
            <PermissionGuard permission='MANAGED_PROJECT:BULK_UPLOAD'>
            ...
            <PermissionGuard permission='MANAGED_PROJECT:EXPORT'>
              <DropdownMenuSeparator />
